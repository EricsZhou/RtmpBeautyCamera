...
public:
    ...
    void setupUi(QWidget *XRtmpBeautyCameraClass)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("src/logo.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        XRtmpBeautyCameraClass->setWindowIcon(icon);
...
"}"));
        ...
        QObject::connect(startButton, SIGNAL(clicked()), XRtmpBeautyCameraClass, SLOT(Stream()));
    ...
    void retranslateUi(QWidget *XRtmpBeautyCameraClass)
    {
        ...
        outUrl->setText(QCoreApplication::translate("XRtmpBeautyCameraClass", "rtmp://192.168.88.129/live", nullptr));
        inUrl->setText(QCoreApplication::translate("XRtmpBeautyCameraClass", "rtsp://192.168.31.66:8554/live", nullptr));
        ...
        face->setItemText(1, QCoreApplication::translate("XRtmpBeautyCameraClass", "\344\272\224\347\272\247\347\276\216\351\242\234", nullptr));
        face->setItemText(2, QCoreApplication::translate("XRtmpBeautyCameraClass", "\345\233\233\347\272\247\347\276\216\351\242\234", nullptr));
        face->setItemText(3, QCoreApplication::translate("XRtmpBeautyCameraClass", "\344\272\214\347\272\247\347\276\216\351\242\234", nullptr));
        face->setItemText(4, QCoreApplication::translate("XRtmpBeautyCameraClass", "\344\270\211\347\272\247\347\276\216\351\242\234", nullptr));
